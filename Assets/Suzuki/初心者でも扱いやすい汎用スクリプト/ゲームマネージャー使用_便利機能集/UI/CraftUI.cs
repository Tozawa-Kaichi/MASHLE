...
public class CraftUI : MonoBehaviour
{
    ...
    [Header("[拡張:クラフト機能]\nボタン画像取得")]
    [SerializeField]
    Image buttonImage; //ボタン自体をいじる時用
    [Header("クラフト時何かのアニメーション")]
    [SerializeField]
    Animator slimeAnim; //クラフト時の食べるアニメーション用
    [Header("クラフト時エフェクトアニメーション")]
    [SerializeField]
    Animator effectAnim; //クラフト時の爆発、煙アニメーション用
    [Header("クラフト時動かすアニメーション")]
    [SerializeField]
    Animator popAnim; //クラフト対象のアイテムをアニメーションで動かす用
    [Header("音を利用できるように取得しよう")]
    [SerializeField]
    AudioSource audioS; 
    [Header("セレクト時の効果音")]
    [SerializeField]
    AudioClip selectse; //項目を切り替えた時の効果音
    [Header("決定時の効果音")]
    [SerializeField]
    AudioClip onse; //決定などの効果音
    [Header("キャンセル時の効果音")]
    [SerializeField]
    AudioClip notse; //キャンセルなどの効果音

    [Header("クラフト時何かの効果音")]
    [SerializeField]
    AudioClip slimese; //スライムの鳴き声、効果音
    [Header("クラフト時システム的な効果音")]
    [SerializeField]
    AudioClip createse; //クラフトの効果音
    [Header("想定外用の画像(？など)")]
    [SerializeField]
    Sprite nullimage; //想定外な場合の画像
    [Header("作成するアイテム")]
